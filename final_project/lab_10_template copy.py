...
if __name__ == "__main__":
    ...
    try:
        ...
        plt.title("FFT of Scope Trace")
        # plt.xlim(0, max(fft_data["frequencies"]))
        plt.show()
        ...
        # '''
        demod_data_radio = demodulate_radio(raw_data, nu_3db=5)
        ...
        demod_data_lockin = demodulate_lockin(ads, duration=15, nu_mod=50, nu_3db=5)

        ### APPROACH COMPARISON

        # if you want to use data from a different run, uncomment the following lines
        # /Users/jasminejaura/Desktop/Physics 111A/lab10/heartbeat_data/demod_lockin20260420-122628.txt
        # dc_baseband_data["x"], dc_baseband_data["y"] = np.loadtxt("./heartbeat_data/demod_lockin20260420-122628.txt")
        # demod_data_radio["x"], demod_data_radio["y"] = np.loadtxt("./heartbeat_data/demod_lockin20260420-122628.txt")
        # demod_data_lockin["x"], demod_data_lockin["y"] = np.loadtxt("./heartbeat_data/demod_lockin20260420-122628.txt")
